...
fun FormUsulanScreen(navController: NavController, userId: String?) {
    ...
    fun validateForm(): Boolean {
        ...
        if (outputSistem.isEmpty()) errors["outputSistem"] = "Output Sistem tidak boleh kosong"
        if (image.value == null) errors["signature"] = "Tanda tangan diperlukan"
    ...
    Column(
        ...
        // Header
        HeaderForm("Form Permohonan Perangkat Lunak", navController)
        ...
        Column(
            ...
            validationErrors["namaSistem"]?.let {
            ...
            validationErrors["jenisSistem"]?.let {
                Text(text = it, color = Color.Red, fontSize = 12.sp)
            }
            ...
            validationErrors["rencanaAnggaran"]?.let {
                Text(text = it, color = Color.Red, fontSize = 12.sp)
            }
            ...
            validationErrors["masalahSistem"]?.let {
                Text(text = it, color = Color.Red, fontSize = 12.sp)
            }
            ...
            validationErrors["outputSistem"]?.let {
                Text(text = it, color = Color.Red, fontSize = 12.sp)
            }
            ...
            // Menampilkan pesan kesalahan tanda tangan jika diperlukan
            validationErrors["signature"]?.let {
                Text(text = it, color = Color.Red, fontSize = 12.sp)
            }

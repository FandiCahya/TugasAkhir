...
fun ProgressCardRiwayat(
    ...
    Card(
        ...
        Row(
            ...
            verticalAlignment = Alignment.CenterVertically, // Menyelaraskan teks dan ikon secara vertikal
            horizontalArrangement = Arrangement.Center // Menyelaraskan teks ke kiri dan ikon ke kanan
        ) {
            // Teks di tengah
            Text(
                text = title,

...
fun generatePDF(
    ...
    canvas.drawText(": $tanggalMulai", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Nama Sistem", labelMargin, currentY, title)
    canvas.drawText(": $namaSistem", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Jenis", labelMargin, currentY, title)
    canvas.drawText(": $jenis", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Rencana Anggaran", labelMargin, currentY, title)
    canvas.drawText(": $rencanaAnggaran", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Masalah", labelMargin, currentY, title)
    canvas.drawText(": $masalah", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Output", labelMargin, currentY, title)
    canvas.drawText(": $output", valueMargin, currentY, title)
    currentY += lineSpacing
...
// Informasi Pengembangan
    ...
    canvas.drawText(": $tanggalSelesai", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Tahap", labelMargin, currentY, title)
    canvas.drawText(": $tahap", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Keterangan", labelMargin, currentY, title)
    canvas.drawText(": $keterangan", valueMargin, currentY, title)
    currentY += lineSpacing
...
// Informasi Pengujian
    ...
    canvas.drawText(": $perangkatLunak", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Versi", labelMargin, currentY, title)
    canvas.drawText(": $versiPerangkat", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Tujuan", labelMargin, currentY, title)
    canvas.drawText(": $tujuanPengujian", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Metode", labelMargin, currentY, title)
    canvas.drawText(": $metodePengujian", valueMargin, currentY, title)
    currentY += lineSpacing

    canvas.drawText("Status", labelMargin, currentY, title)
    canvas.drawText(": $status", valueMargin, currentY, title)
    currentY += lineSpacing
...
// Baris pertama (Nama Pihak: User)
    ...
    canvas.drawText(
        ...
        tableTop + 65f,
        title
    )  // Tempat untuk tanda tangan (kosong)
